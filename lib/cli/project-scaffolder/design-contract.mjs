  ...
  return {
    ...
    conceptualAnchor: {
      ...
      userResearchAbsencePolicy: {
        ...
        unavailableResearchFallback: 'state-the-limitation-and-synthesize-from-product-context-without-pretending-offline-seed-is-research',
      },
      ...
      visualRiskBudget: {
        ...
        requirePerformanceBudgetNotes: true,
      },
      requiredDerivedAxes: [
        'typography',
        'spacing',
      ...
      finalAnchorContract: {
        ...
        cohesionChecks: [
          ...
          'tokens-derived-from-anchor',
          'morphology-derived-from-anchor',
          'motion-derived-from-anchor',
          'responsive-recomposition-derived-from-anchor',
        ],
      },
    },
    mathSystems: {
    ...
    reviewRubric: {
      ...
      genericitySignals: [
        ...
        'user-research-absence-treated-as-offline-seed-permission',
      ...
      validBoldSignals: [
        ...
        'agent-led-research-backed-anchor',
    ...
    experiencePrinciples: [
      ...
      'Absent user-supplied research, the agent must run agent-led synthesis or live research when available; the scaffold seed and prior UI never count as research.',
      'Do not flatten expressive motion or spatial interaction unless accessibility, performance, or product clarity requires it.',
