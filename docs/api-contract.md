...
Default init enables ASCX command guidance through `.agent-context/state/token-optimization.json` and Compact Natural Mode through `.agent-context/prompts/compact-natural-mode.md`.
