...
**What to do**: Infer the stack from requirements and evidence; enforce language-specific conventions dynamically.
...
**What to do**: When user asks "create new [framework] project", choose the best-fit playbook and scaffold accordingly.
...
3. Universal SOP hard gates satisfied (`docs/architecture-decision-record.md`, and `docs/DESIGN.md` for UI scope)
