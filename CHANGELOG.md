...
- Added `tests/migrate-rule-format.test.mjs` with 12 tests covering the prefix table, parser, renderer, roundtrip checker, and the end-to-end migration helper. Test count rises from 125 to 137. The new test file is wired into `npm test`.
